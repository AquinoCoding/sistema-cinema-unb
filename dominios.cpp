...
bool Capacidade::validar(float capacidade) { // octavio - 190094087
    capacidade /= 100;
...
bool Cargo::validar(string cargo) { // octavio - 190094087
...
bool Classificacao::validar(string classificacao){ // octavio - 190094087
...
bool Codigo::validar(string codigo){ // Lorenzo - 200022610
    int flag = 0;
...
bool Data::validar(string data){ // Lorenzo - 200022610
...
bool Email::validar(string email) { // Lorenzo - 200022610
...
bool Horario::validar(string horario){ // Eder - 170140636
...
bool Matricula::validar(string matricula){ // Eder - 170140636
    int j=1;
    int contadigito=0;
...
bool Nome::validar(string nome) { // Lorenzo - 200022610
    int flag=0;
...
bool Senha::validar(string senha){ // octavio - 190094087
...
bool Telefone::validar(string telefone){ // Lorenzo - 200022610
    char dd_char[2];
...
bool Tipo::validar(string tipo){ // Eder - 170140636
